...
<head>
	...
	<style>
		...
		@media (max-width: 768px) {
			...
			.order-table td:nth-of-type(11):before { content: "操作:"; }
...
<div class="container nav-container">
	<ul id="Tab" class="nav nav-pills" style="justify-content: center; flex-wrap: wrap;">
		...
		<li class="active"><a href="getStatusFourOrder"><i class="fa fa-list-alt"></i> 可配送订单</a></li>
			...
			<table class="order-table">
				...
				<c:forEach var="oa" items="${orderlist}">
					<tr>
						...
						<td>${oa.rider_id}</td>
						<td>
							<a href="grabOrder?order_on=${oa.order_on}">
								<button type="button" class="grab-btn">
									<i class="fa fa-hand-paper-o"></i> 抢单
								</button>
							</a>
						</td>
					</tr>
